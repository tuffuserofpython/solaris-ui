...
function Tab:AddSection(opts: table)
	local Section = (rawget(_G,'_SolarisReg') and _G._SolarisReg['components/Section']) or (rawget(_G,'_SolarisReg') and _G._SolarisReg['components/Section']) or require(script.Parent.Section)
